...
const CoursesTable: FC<CoursesTableProps> = ({ courses, tableConfig, isMobile }) => {
    ...
    return (
        courses && courses.length ? (
            isMobile ?
                <MobileCourseTable currentItems={currentItems} config={config} /> : <DesktopCoursesTable currentItems={currentItems} config={config} />
        ) : (
