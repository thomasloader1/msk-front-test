...
const PageAuthor: FC<PageAuthorProps> = ({className = ""}) => {
    ...
    return (
        <div className={`nc-PageAuthor  ${className}`} data-nc-id="PageAuthor">
            ...
            <div className="">
                <div
                    className="bg-neutral-200 dark:bg-neutral-900 dark:border dark:border-neutral-700 p-5 lg:p-16 flex flex-col sm:items-center">
                    <Avatar
            ...
            <div className="container py-16 lg:pb-28 lg:pt-20 space-y-16 lg:space-y-28">
                <main>
                    ...
                    <div
                        className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 sm:gap-6 md:gap-8 ">
