            ...
            >
                ...
                <div className="max-w-md mx-auto space-y-6">
                    ...
                    >
                        ...
                        >
                            <button disabled={formDisabled} className="nc-Button relative h-auto inline-flex items-center justify-center transition-colors rounded text-sm sm:text-base font-medium px-4 py-3 sm:px-6  ttnc-ButtonPrimary disabled:cursor-not-allowed disabled:bg-grey-disabled bg-primary-6000 text-neutral-50 false w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0" type="submit">Enviar</button>
                        </div>
                    </form>
                </div>
            </LayoutPage>
